              ...
              <div className="flex-1 p-5 md:p-6">
                ...
                <div className="flex items-center justify-between mb-4">
                  <div className="flex items-center gap-3">
                    <div className={`w-10 h-10 rounded-[10px] flex items-center justify-center flex-shrink-0 ${f.code === 'UA' ? 'bg-[#0032A0]' : 'bg-[#01426A]'}`}>
                      <span className="font-mono text-[0.7rem] font-bold text-white tracking-wider">{f.code}</span>
                    </div>
                    <div>
                  ...
                  <div className="flex items-center gap-1.5 text-right">
                    <Clock size={12} className="text-smoke-light" />
                    <span className="font-mono text-[0.6rem] text-smoke">{f.duration}</span>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-4">
                  <div className="text-left">
                    ...
                    <p className="font-mono text-[0.6rem] text-volcanic font-medium mt-0.5">{f.depart}</p>
                  </div>

                  <div className="flex-1 flex items-center justify-center gap-2 px-2">
                    <div className="flex-1 h-px bg-border relative">
                      <div className="absolute left-0 top-1/2 -translate-y-1/2 w-1.5 h-1.5 rounded-full bg-celeste" />
                    </div>
                    ...
                    <div className="flex-1 h-px bg-border relative">
                      <div className="absolute right-0 top-1/2 -translate-y-1/2 w-0 h-0 border-l-[5px] border-l-coral border-y-[3px] border-y-transparent" />
                    </div>
                  </div>
                  ...
                  <div className="text-right">
                    ...
                    <p className="font-mono text-[0.6rem] text-volcanic font-medium mt-0.5">{f.arrive}</p>
                  </div>
                </div>
              </div>
